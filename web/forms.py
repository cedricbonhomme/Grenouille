...
class SignupForm(Form):
    ...
    def validate(self):
        ...
        if self.firstname.data != User.make_valid_nickname(self.firstname.data):
            self.firstname.errors.append(
                "This firstname has invalid characters. Please use letters, numbers, dots and underscores only."
            )
            return False
        if self.lastname.data != User.make_valid_nickname(self.lastname.data):
            self.lastname.errors.append(
                "This lastname has invalid characters. Please use letters, numbers, dots and underscores only."
            )
            return False
        return True
